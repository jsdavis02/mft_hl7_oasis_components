...
for fname in os.listdir(args.input):
    ...
    sname = 'BE6090477.file'
    ename = os.path.join(args.output, sname)
    encrypt = "/bin/gpg --sign --armor --always-trust --batch -c --yes --passphrase "+pass_phrase+" --recipient "+key_id+" --output "+ename+" --encrypt "+fp
    os.system(encrypt)
