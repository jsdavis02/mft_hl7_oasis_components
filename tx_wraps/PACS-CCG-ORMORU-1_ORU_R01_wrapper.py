...
from oasis_fun import trim_trailing_sub_fields
from oasis_fun import trim_trailing_empty_fields
from oasis_fun import truncate_orc
from oasis_fun import truncate_segment
from oasis_fun import delete_segments
from oasis_fun import copy_obr_32_33
...
json_in = truncate_orc.truncate_orc(json_in, 14)

#remove nte and zds
json_in = delete_segments.delete_segments(json_in, ('NTE', 'ZDS'))

json_in = copy_obr_32_33.copy_obr_32_33(json_in)

json_in = truncate_segment.truncate_segment(json_in, 'OBR', 36)

json_in = trim_trailing_sub_fields.trim_trailing_sub_fields(json_in)

json_in = trim_trailing_empty_fields.trim_trailing_empty_fields(json_in)
