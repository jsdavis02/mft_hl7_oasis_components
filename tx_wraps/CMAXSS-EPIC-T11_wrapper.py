...
from oasis_fun import update_txa_19
...
# Call function that updates PV1 19
json_in = update_pv1_19.update_pv1_19(json_in)

# Call function that updates TXA 19
json_in = update_txa_19.update_txa_19(json_in, "update_txa_19", args.env)
