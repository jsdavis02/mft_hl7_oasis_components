...
from oasis_fun import update_pv1_2_with_table
from oasis_fun import update_pid_10_with_table
...
json_in = update_pv1_2_with_table.update_pv1_2_with_table(json_in, 'EPIC_PIECES_PATIENT_CLASS', args.env)

json_in = update_pid_10_with_table.update_pid_10_with_table(json_in, 'EPIC_PIECES_PATIENT_RACE', args.env)
