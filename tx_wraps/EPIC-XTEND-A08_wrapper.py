...
from oasis_fun import update_pv1_16_18
...
deletekeys = ('CON', 'NK1', 'NTE', 'ZPV', 'ZIN', 'AL1', 'DG1', 'GT1', 'PD1', 'PV2', 'IN1', 'IN2')

# Call function that updates PV1
json_in = update_pv1_16_18.update_pv1_16_18(json_in, "xtend_pv1", args.env)
