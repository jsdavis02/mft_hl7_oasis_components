...
# Set Kronos MFT schedules active
enable_sched = "update mft_schedule set mft_schedule.active = 1 from mft_schedule inner join endpoints e on mft_schedule.endpoint_id = e.id where lower(e.bw_process_ident) like lower('%sftp-kronos%')"
print(enable_sched)
cursor = cnxn.cursor()
